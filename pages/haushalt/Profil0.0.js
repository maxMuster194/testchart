...
export default function StrompreisChart() {
  ...
  const legendItems = [
    { label: 'Strompreise', color: '#FFC107' },
  ...
  return (
    <div style={styles.container}>
      ...
      <h1 style={styles.title}>🇩🇪 Profil 0.0</h1>
