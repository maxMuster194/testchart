...
export default function StrompreisChart() {
  ...
  const combinedChartOptions = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: `Strompreise, H0, H0PV*Strompreis, H0*Preis und H0*Strompreis am ${formatDateForComparison(selectedDate) || 'N/A'}`,
  ...
  return (
    <div style={styles.container}>
      ...
      <h1 style={styles.title}>🇩🇪 PV-Anlage kaufen Vergleich</h1>
