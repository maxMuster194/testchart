...
import H0PVChart from './grafik-final-h0pv'; // Import der neuen Komponente
    ...
    <div>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.rightColumn}>
          ...
          {/* Neue Grafik aus grafik-final-h0pv.js */}
          <div style={styles.chartContainer}>
            <h2 style={styles.chartTitle}>📈 H0 / H0+PV Vergelich (0–23 Uhr)</h2>
            <H0PVChart selectedDate={selectedDate} /> {/* Übergabe des ausgewählten Datums */}
          </div>
        </div>
      </div>
    </div>
