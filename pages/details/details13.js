  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .container {
          width: 1620px; /* 800px + 800px + 20px Gap */
        ...
        .diagram-placeholder {
          width: 752px; /* 800px - 24px Padding links - 24px Padding rechts */
          height: 600px;
        ...
        .chart-container {
          width: 752px; /* 800px - 24px padding left - 24px padding right */
          height: 600px; /* Fixed height as per original design */
          margin: 0 auto;
        }
      `}} />
