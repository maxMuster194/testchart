...
function DetailsPage() {
  ...
  const handleErweiterteEinstellungChange = (verbraucher, field, value, zeitraumId) => {
    ...
    const isDynamisch = ['waschmaschine', 'geschirrspüler', 'wäschetrockner', 'herd', 'multimedia', 'licht'].includes(verbraucher);
    if (isDynamisch) {
  ...
  return (
    <div className="container mx-auto p-4 max-w-4xl">
      <h1 className="text-3xl font-bold text-center text-gray-800 mb-6">Stromverbrauch Rechner - Details</h1>
